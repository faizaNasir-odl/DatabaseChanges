...
public partial class OpcSourceTag
{
    ...
    public virtual ICollection<DeviceTimeStampIdmapping> DeviceTimeStampIdmappingIdSourceTagIdFkNavigations { get; set; } = new List<DeviceTimeStampIdmapping>();

    public virtual ICollection<DeviceTimeStampIdmapping> DeviceTimeStampIdmappingTimeStampSourceTagIdFkNavigations { get; set; } = new List<DeviceTimeStampIdmapping>();
