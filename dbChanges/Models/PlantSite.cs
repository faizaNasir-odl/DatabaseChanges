...
public partial class PlantSite
{
    ...
    public int? AllowedTags { get; set; }

    public string? TagDiagnosticsNotifcationGroups { get; set; }

    public string? ReadApiDashboardNotificationGroups { get; set; }

    public bool? IsReadApiNotificationAllowed { get; set; }
