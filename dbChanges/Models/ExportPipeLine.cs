...
public partial class ExportPipeLine
{
    ...
    public string? DataPointAggregation { get; set; }

    public TimeOnly? StartTimeToPullData { get; set; }

    public TimeOnly? EndTimeToPullData { get; set; }
    ...
    public virtual ICollection<PipeLineTag> PipeLineTags { get; set; } = new List<PipeLineTag>();
}
