...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__action__3213E83F962EFCAC");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__agent__3213E83FEB494525");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__agent_in__3213E83FEE7DF786");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__agent_ve__3214EC073770DC42");

            entity.ToTable("agent_version", "dss");

            entity.HasIndex(e => e.Version, "UQ__agent_ve__0F540134EF44EB6E").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__buffer__3213E83F335FFD3B");

            entity.ToTable("buffer", tb =>
                {
                    tb.HasTrigger("buffer_dss_delete_trigger");
                    tb.HasTrigger("buffer_dss_insert_trigger");
                    tb.HasTrigger("buffer_dss_update_trigger");
                });
            ...
            entity.Property(e => e.RetentionTime)
                .HasColumnType("datetime")
                .HasColumnName("retention_time");
            entity.Property(e => e.Site)
                .HasMaxLength(255)
                .HasColumnName("site");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__configur__3214EC0706AF4FFB");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__EnumType__3214EC0707F218FC");
        ...
        {
            entity.HasKey(e => e.JobId).HasName("PK__Job__056690C2F50A416F");
        ...
        {
            entity.HasKey(e => e.MessageId).HasName("PK__MessageQ__C87C0C9CD96D2827");
            ...
            entity.HasOne(d => d.Job).WithMany(p => p.MessageQueues)
                ...
                .HasConstraintName("FK__MessageQu__JobId__23D42350");
        });

        modelBuilder.Entity<MetaInformation>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__MetaInfo__3214EC074CA08663");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__MetaInfo__3214EC074940567D");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__scaleuni__3214EC07CD792DB7");
        ...
        {
            entity.HasKey(e => e.ScheduleId).HasName("PK__Schedule__9C8A5B4934418EE6");
        ...
        {
            entity.HasKey(e => e.ScheduleTaskId).HasName("PK__Schedule__8DAD173A35A14E44");
            ...
            entity.HasOne(d => d.ScheduleNavigation).WithMany(p => p.ScheduleTask1s)
                ...
                .HasConstraintName("FK__ScheduleT__Sched__2E51B1C3");
        });
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__subscrip__3213E83F804C8913");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__syncgrou__3213E83FBBD687F7");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__syncgrou__3213E83F05D59433");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__task__3213E83FC9743AB6");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__userdata__3213E83FB4F4C563");
